...
export default async function AboutTeam({ imgs }: { imgs?: Record<string, string> } = {}) {
  ...
  return (
    <section className="bg-[#080C1A] py-16 lg:py-40">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-16">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-12 lg:mb-16">
          <h2 className="font-serif text-3xl sm:text-4xl lg:text-6xl text-white leading-tight">
            Our Leadership<br />
        ...
        <div className="mt-10 lg:mt-16 grid md:grid-cols-2 gap-4">
          <div className="relative rounded-[2rem] overflow-hidden h-56 sm:h-64 md:h-72">
            ...
            <div className="absolute bottom-4 left-4 sm:bottom-6 sm:left-6">
              <span className="text-white font-serif text-base sm:text-lg">Management Team</span>
          ...
          <div className="relative rounded-[2rem] overflow-hidden h-56 sm:h-64 md:h-72">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-brand-navy/60 to-transparent" />
            <div className="absolute bottom-4 left-4 sm:bottom-6 sm:left-6">
              <span className="text-white font-serif text-base sm:text-lg">200+ Professionals</span>
